...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="{{ asset('assets/backends/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}">
  <!-- Theme style -->
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="{{ route('login') }}" class="h1"><b>BIHS</b></a>
    </div>
    <div class="card-body">
